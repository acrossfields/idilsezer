...
<div class="homefield" style="--grad-start: #4d7e9d; --grad-end: #0b2428; font-size: 20px; color: #4d7e9dff">
  <div style="text-align: center; margin: 0; padding: 10px;">
    <b>Engineering</b>
  </div>
  <img src="/idilsezer/assets/images/edu.png" alt="Engineering" style="width: 70px; height: 70px; object-fit: contain; display: block; margin: 0 auto; padding: 10px;">
</div>
