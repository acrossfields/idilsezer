  ...
  <table class="table-bgsub" style="color: #162736; margin: 10px 0; padding: 0;">
    ...
    <tr class="table-bgsub-details">
      <td colspan="3" style="padding: 5px;">
        ...
        <ul style="margin: 0; padding: 8px 0 0 13px; font-size: 14px;">
          <li style="line-height: 1.2;">Preparing carbon/epoxy and kevlar/epoxy composite plates with the hand lay-up method</li>
          <li style="line-height: 1.2;">The measurement of the mechanical properties of the prepared test specimens</li>
          <li style="line-height: 1.2;">Setting up the test fixture</li>
          <li style="line-height: 1.2;">The documentation of the results</li>
        </ul>
      </td>
    </tr>
  </table>
